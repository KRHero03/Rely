...
class _AccountState extends State<Account> {
  ...
  _goToTransactionDetails() {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => TransactionDetails(uid: user.uid)));
    }
    
    _goToEditProfile(){
      Navigator.push(context, MaterialPageRoute(builder: (context) => EditProfile(uid:user.uid,imageURL: imageURL)));
    }
