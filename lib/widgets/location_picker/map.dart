...
import 'package:Rely/widgets/location_picker/loading_builder.dart';
import 'package:Rely/widgets/location_picker/log.dart';
                ...
                children: <Widget>[
                  ...
                  widget.resultCardConfirmWidget ??
                      FloatingActionButton(
                        ...
                        child: Icon(MdiIcons.chevronRight,color: Colors.white,size: 34),
                      ),
                ],
              ),
            );
    ...
    return IgnorePointer(
      child: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            Icon(MdiIcons.mapMarker, size: 56,color: Color(0xff4564e5)),
            Container(
        ...
        children: <Widget>[
          if (layersButtonEnabled)
            FloatingActionButton(
              ...
              mini: true,
              child: const Icon(MdiIcons.layers,color: Colors.white),
              heroTag: "layers",
            ),
          if (myLocationButtonEnabled)
            FloatingActionButton(
              ...
              materialTapTargetSize: MaterialTapTargetSize.padded,
              mini: true,
              child: const Icon(MdiIcons.mapMarker,color: Colors.white),
              heroTag: "myLocation",
            ),
        ],
      ),
